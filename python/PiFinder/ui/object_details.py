...
DM_CONTRAST = 5  # Display mode for Contrast Reserve explanation
...
class UIObjectDetails(UIModule):
    ...
    def cycle_display_mode(self):
        ...
        # (Mount control mode accessible via key_number but not in main cycle)
        if self.object_display_mode == DM_LOCATE:
        ...
        else:  # DM_CONTRAST, DM_MOUNT_CONTROL, or any other mode
            self.object_display_mode = DM_LOCATE
